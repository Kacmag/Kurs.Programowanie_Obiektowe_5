...
class LaczeDoGNUPlota {
 protected:
  ...
  int           _Wyjscie_GNUPlota;
   /*!
    *  \brief Decyduje czy mają być wyświetlane komuniangley o błędach
    *
    *  Wartość tego pola decyduje o tym czy komuniangley o błędach będą 
    *  wyświetlane na wyjście standardowe błędów (\b cerr), czy też nie.
    *   \li \p true - komuniangley będę wyświetlane,
    *   \li \p false -  komuniangley nie będę wyświetlane.
    */
  bool          _WyswietlajKomuniangleyOBledach;
  /*!
  ...
  /*!
   * \brief Określa latest tryb rysowania
   *
  ...
  std::string ZapiszUstawienieRotacjiISkali() const;
    ...
    *  \param[in] Polecenie - komuniangle przeznaczony do przeslania.
    *
   ...
   *  \link LaczeDoGNUPlota::_WyswietlajKomuniangleyOBledach
   *            _WyswietlajKomuniangleyOBledach\endlink.
   *  Określa ono, czy mają być wyświetlane komuniangley o błędach na wyjście
   *  standardowe, czy też nie.
   *  \retval true - komuniangley mają być wyswietlane na wejściu \p standard \p error.
   *  \retval false - komuniangley nie mają być wyświetlane.
   */
  bool CzyWyswietlacKomuniangley() const { return _WyswietlajKomuniangleyOBledach;}
  /*!
   ...
   *
   * Wyświetla na wyjście "standard error" komuniangle (przekazany jako
   * parametr), o ile pole 
   *   \link LaczeDoGNUPlota::_WyswietlajKomuniangleyOBledach
   *          _WyswietlajKomuniangleyOBledach\endlink  ma wartość
   * \p true. W przypadku przeciwnym komuniangle nie jest wyświetlany.
   * \param[in] sKomuniangle - treść komuniangleu, który ma być wyświetlony.
   */
  void KomuniangleBledu(const char *sKomuniangle) const;
 ...
 public:
   ...
   */
  void XrangeSet(float Xo, float Xn) { _Xmin = Xo;  _Xmax = Xn; }
  /*!
   ...
   */
  void YrangeSet(float Yo, float Yn) { _Ymin = Yo;  _Ymax = Yn; }
  /*!
   ...
   */
  void ZrangeSet(float Zo, float Zn) { _Zmin = Zo;  _Zmax = Zn; }
   ...
   *                 jest w stopniach.
   */
  void XZrotationSet( float KatX_st, float KatZ_st ); 

  /*!
   *  \brief Zezwala lub zabrania wyświetlania komuniangleów.
   *
   *  Metoda pozwala, albo też zabrania wyświetlania komuniangleów o blędach.
   ...
   *  komuniangley, które kierowane są na wyjście "standard error"
   *  Domyślnie przymuje się, że programista nie chce, aby wyświetlały się
   *  dodatkwe komuniangley. Wywołując tę metodę można to zmienić.
   *  \param[in] WyswietlajKomuniangley - wartość parametru zostaje zapamiętana.
   *                   Jeśli jest ona \p true (domyślna wartość parametru), to 
   *                   komuniangley będą wyświetlane. Gdy jest ona \p false,
   *                   to komuniangley nie będą wyświetlane.
   */
  void WyswietlajKomuniangleyBledow( bool  WyswietlajKomuniangley = true );
